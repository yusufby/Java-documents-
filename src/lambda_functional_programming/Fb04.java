...
public class Fb04 {
    ...
    public static void printUpperCase01(List<String> list) {
        ...
        // to update elements we use map methods.
    }
   ...
   /* public static void printUpperCase02(List<String> list) {
    ...
    //3) Create a method to print the elements after ordering according to their lengths (in ascending order)
    ...
    // Using STREAM is not a must in functional programming
    ...
    public static void printAllElementsByTheirLengthAndFirstInitialChars(List<String> list) {
        list.stream().
                sorted(Comparator.comparing(String::length).//sort the elements according to their lengths
                        thenComparing(t -> t.charAt(0))). // you can compare thenComparing with sub-topic
                forEach(Utils::printInSameLineWithSpace);
    }
