    ...
    /*
        1)Access modifier of the "Overriding Method"(The method inside the child class) CANNOT be narrower(can be same or wider)
         ...
         2)Return Types must have "IS-A" Relationship from "Overriding Method"(child) to "Overridden Method"(parent)
           ...
           Note: Java did not create "parent - child" relationship between "wrapper classes"
           because of that if return type is one of the wrapper class
         ...
         4) "static methods" are common for all objects, if you override and change the implementation
          all other objects will be affected from the update but
            that can create many issues because of that Java does not let to override static methods.S
         ...
         6) What is the difference between "Method Overloading" and "Method Overriding"?
            i) "Method Overloading" is done in just a single class but "Method Overriding" needs multiple
             classes with "parent-child relationship"(inheritance)
